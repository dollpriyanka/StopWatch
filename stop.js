const time = document.querySelector('.time');
    ...
    `${format(milliseconds.toString().split('')[milliseconds.toString().length - 2])}` : `${milliseconds.toString().split('')[milliseconds.toString().length - 3]}${milliseconds.toString().split('')[milliseconds.toString().length - 2]}`;
